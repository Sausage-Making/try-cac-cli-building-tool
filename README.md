...
# Try-out: npm CLI Building Tool cac v7.0.0

Brief try-out of the npm CLI Building Tool [cac](#cac-npm-package) as a basis for usages and / or more elaborated evaluations elsewhere
  * Used package version of cac: 7.0.0

*[hh lohmann &lt;hh.lohmann@gmail.com&gt;](mailto:hh.lohmann@gmail.com?subject=try-cac-cli-building-tool)*
...
<p align="center" id="github_readme_pages_switch" style="display:none;">
  ...
  <a href="https://hh-lohmann.github.io/try-cac-cli-building-tool">GitHub Pages view</a>
  </i></b>
</p>
...
<p id="github_readme_demos_switch">
  See <a href="https://hh-lohmann.github.io/try-cac-cli-building-tool/demos" onclick="if(location.hostname.replace(/\d/g,'').replaceAll('.','')===''||location.hostname==='localhost'){this.href='./demos/';alert('Dev environment detected - switching to local version');}">demos</a><span style="display:none;"> on GitHub Pages for this repo</span>
</p>
...
### cac npm package
  * npmx.dev entry: <https://npmx.dev/package/cac>
  * npm registry: <https://npmjs.com/package/cac>
